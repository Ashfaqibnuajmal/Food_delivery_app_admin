...
// class FooditemScreesn extends StatelessWidget {
//   const FooditemScreesn({super.key});
...
//                                     onPressed: () async {
//                                       await foodService
//                                           .deleteFoodItem(food.foodItemId);
//                                     },
//                                     style: ElevatedButton.styleFrom(
...
//               //               child: Center(
//               //                 child: Text(
//               //                   "${food["name"]}\n${food["prepTime"]} min | ${food["calories"]} kcal ${food["description"]}",
//               //                   textAlign: TextAlign.center,
//               //                   style: const TextStyle(
//               //                     color: AppColors.pureWhite,
//               //                   ),
